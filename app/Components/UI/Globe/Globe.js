...
export default function Globe({ className = "" }) {
  ...
  const classes = [styles.globe, className].filter(Boolean).join(" ");
  ...
  return (
    <div ref={globeRef} className={classes} aria-hidden="true">
      ...
      <div className={styles.globeFront}>
        <div className={styles.globeMirror}>
          {globeCircles.map((_, index) => (
            <div className={styles.globeCircle} data-globe-circle key={index}>
